...
function fiveRounds() {
  if (
    overallPlayerScore.value == 5 &&
    overallComputerScore.value < overallPlayerScore.value
  ) {
    alert("Player victorious! Machine is crushed!");
    console.log("Player victorious! Machine is crushed!");
  } else if (
    overallComputerScore.value == 5 &&
    overallPlayerScore.value < overallComputerScore.value
  ) {
...
function playerChoice() {
  ...
  rockBtn.addEventListener("click", () => {
    ...
    if (playerSelection === computerSelection) {
      ...
      overallPlayerScore.value =
        parseInt(overallPlayerScore.value) + parseInt(1);
      resultInput.value = "Player";
    } else if (computerSelection === "paper") {
      battleLog.value = "Paper beats rock!";
      console.log("Paper beats rock!");
      overallComputerScore.value =
        parseInt(overallComputerScore.value) + parseInt(1);
